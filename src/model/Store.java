...
public class Store implements Location {
    ...
    static {
        ...
        // misc
        storeInventory.addItem(MiscRegistry.getMisc("Coal"), 999);
        buyPriceMap.put("Coal", 10);

        storeInventory.addItem(MiscRegistry.getMisc("Firewood"), 999);
        buyPriceMap.put("Firewood", 15);

        storeInventory.addItem(MiscRegistry.getMisc("Proposal Ring"), 1);
        buyPriceMap.put("Proposal Ring", 1000);
    }
