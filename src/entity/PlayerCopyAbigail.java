...
//     public final int screenX; // Screen X position
//     public final int screenY; // Screen Y position
...
//         worldX = gp.tileSize * 23; // Set the player's initial X position
//         worldY = gp.tileSize * 21; // Set the player's initial Y position
...
//         try {
//             stand = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_stand.png")); // Load the player's standing image
//             // Load the player's images for different directions
//             up1 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_up_1.png")); // Load the player's up image
//             up2 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_up_2.png")); // Load the player's up image
//             down1 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_down_1.png")); // Load the player's down image
//             down2 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_down_2.png")); // Load the player's down image
//             left1 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_left_1.png")); // Load the player's left image
//             left2 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_left_2.png")); // Load the player's left image  
//             right1 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_right_1.png")); // Load the player's right image
//             right2 = ImageIO.read(getClass().getResourceAsStream("/res/image/abigail/abigail_right_2.png")); // Load the player's right image
...
//         g2.drawImage(image, screenX, screenY, gp.tileSize, gp.tileSize, null); // Draw the image at the player's position
//     }
// }
